    ...
    <section id="ranking" class="info">
        ...
        <div class="info-section-gray" style="min-height: 470px;">
            ...
            <div class="container">
                <header>
                    <h1>Ranking <?php if (empty($nama_sekolah)) { ?>SMA<?php } else { echo $nama_sekolah->NAMA_SEKOLAH; }?></h1>
                                    ...
                                    <?php }
                                        ...
                                        foreach ($ranks as $rank) {?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url(); ?>ranking/siswa/<?php echo $rank['NO_UJIAN']; ?>"><?php echo $rank['NAMA']; ?></a></td>
